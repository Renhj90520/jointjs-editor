joint.ui.TextEditor = joint.mvc.View.extend(
  {
    ...
    onInput: function(a) {
      if (this.textContentHasChanged()) {
        var b =
            this.textarea.value.length - this._textareaValueBeforeInput.length,
          c = {
      ...
      return (
        joint.util.toArray(b).forEach(function(b) {
          void 0 === b.start && void 0 === b.end
            ? V.mergeAttrs(c, b.attrs)
            : a >= b.start && a < b.end && V.mergeAttrs(c, b.attrs);
        }),
        c
      );
    },
                  ...
                  if (
                    (b.textProperty &&
                      (b.cellView.model.isLink() &&
                        ...
                        (f = V($(V(d).node).closest('.label')[0]).index()),
      ...
      applyAnnotations: function(a) {
        ...
        if (this.ed && b.update) {
          b.cellView && b.annotationsProperty
            ...
            : V(this.ed.options.text).text(this.ed.getTextContent(), a);
