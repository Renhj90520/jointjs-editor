export function extendShapeCloud() {
  joint.shapes.custom.Cloud = joint.dia.Element.extend({
    markup: [
      '<g class="rotatable">',
      "<g class='scalable'>",
      // '<svg viewBox="0 0 640 512" width="120px" height="80px" preserveAspectRatio = "xMinYMid meet">',
      ...
      // '</g>',
      // '</svg>',
      '<g width="120" height="80" viewBox="0 0 120 80">',
      '<svg viewBox="0 0 384 512" width="120px" height="80px" preserveAspectRatio = "xMidYMid meet">',
